...
```{sh, eval = FALSE}
genome='Share/day03/results/genome/genome.fa'
peaks_folder='Share/day03/results/bwa/mergedLibrary/macs/narrowPeak/'
TF='Reb1_R1'
fasta_path="${TF}.fa"
...
<details><summary style="color: #ff7f00; font-weight: bold">Show code</summary><p>
```{r}
Reb1_peak_summits <- rtracklayer::import('Share/day03/results/bwa/mergedLibrary/macs/narrowPeak/Reb1_R1_summits.bed')
...
```{r}
`%over%` <- IRanges::`%over%`
yeast_sequences <- Biostrings::readDNAStringSet('Share/day03/results/genome/genome.fa')
yeast_sequences
...
Abf1_peaks <- rtracklayer::import('Share/day03/results/bwa/mergedLibrary/macs/narrowPeak/Abf1_R1_peaks.narrowPeak')
...
<details><summary style="color: #ff7f00; font-weight: bold">Show code</summary><p>
```{r}
Rap1_peaks <- rtracklayer::import('Share/day03/results/bwa/mergedLibrary/macs/narrowPeak/Rap1_R1_peaks.narrowPeak')
