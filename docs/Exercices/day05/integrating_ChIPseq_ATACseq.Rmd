---
title: "Ex. 05-1: Leveraging AnnotationHub to investigate epigenomics"
output: 
...
<details><summary style='color: #ff7f00; font-weight: bold'>Show code</summary><p>
```{r}
query(ah, c("Saccharomyces cerevisiae", "release-102"))
yeast_gtf <- ah[['AH87694']]
...
> So is AnnotationHub really informative? In which organism/context could it be useful? 
